...
-(void)initTables{
    ...
    NSString * createActionTableSql = [NSString stringWithFormat:@"create table if not exists %@ (node_id integer, action_id integer,action_name text)",TABLE_NAME_APPROVE_ACTION_LIST];
